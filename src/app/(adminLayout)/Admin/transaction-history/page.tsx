...
export default function AdminTransactionsPage() {
  ...
  if (!user || user.role !== "ADMIN") {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 dark:bg-gray-900">
        <div className="rounded-xl border border-red-200 dark:border-red-700 bg-red-50 dark:bg-red-900/40 px-4 py-3 text-sm text-red-700 dark:text-red-300">
          ...
          <div className="md:hidden p-4 space-y-4">
            ...
            {loading ? (
              ...
              data.map((tx) => (
                <div
                  key={tx.id}
                  className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-800 shadow-sm"
                >
