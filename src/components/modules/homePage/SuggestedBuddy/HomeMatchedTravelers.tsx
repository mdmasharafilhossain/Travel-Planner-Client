        ...
        {matches.length === 0 ? (
          ...
          >
            ...
            <Link
              href="/explore"
              className="
                px-6 py-3 rounded-lg bg-orange-500 text-white 
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Image
                    ...
                    width={48}
                    height={48}
                    className="rounded-full object-cover ring-2 ring-orange-100 dark:ring-orange-400/30"
