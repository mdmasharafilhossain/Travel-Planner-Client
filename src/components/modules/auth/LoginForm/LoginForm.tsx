...
async function onSubmit(data: LoginType) {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-12 bg-gray-100 dark:bg-gray-900">

      <div className="w-full max-w-md bg-white/90 dark:bg-gray-800/90 backdrop-blur-md border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg overflow-hidden">

        {/* Header */}
        <div className="px-6 py-8 bg-linear-to-r from-orange-50 to-white dark:from-gray-800 dark:to-gray-900 border-b border-gray-100 dark:border-gray-700">
