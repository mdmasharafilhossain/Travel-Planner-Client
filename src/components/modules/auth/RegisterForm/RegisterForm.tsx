...
export default function RegisterForm() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-gray-50 dark:bg-gray-900">
      ...
      <div className="w-full max-w-lg bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl overflow-hidden">

        {/* Header */}
        <div className="px-8 py-6 bg-linear-to-r from-orange-50 to-white dark:from-gray-800 dark:to-gray-900 border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-300">
                Join TravelPlanner — manage trips, plans and more.
              </p>
            </div>
