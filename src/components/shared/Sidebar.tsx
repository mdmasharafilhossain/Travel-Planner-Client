...
<div className="md:hidden fixed top-0 left-0 right-0 h-14 z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 shadow">
  ...
  <span className="text-base font-extrabold bg-linear-to-r from-orange-500 to-gray-700 bg-clip-text text-transparent">
    Admin Dashboard
  </span>
              ...
              return (
                <li key={item.name}>
                  ...
                  >
                    ...
                    />
                    {(!isCollapsed || isMobileOpen) && <span className="font-semibold text-sm">{item.name}</span>}
                  </Link>
                </li>
              );
            })}
